            ...
            <form action="../Controllers/C_inscription.php" method="post">
                ...
                <div class="form-group">
                    <select id="statut" name="statut">
                        <option disabled Value=""> --Quel est votre statut ?-- </option>
                        <option Value="utilisateur_simple"> utilisateur_simple </option>
                        <option Value="Organisateur_evt"> Organisateur d'évènements </option>
